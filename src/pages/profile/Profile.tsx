    ...
    <div className="flex flex-col min-h-screen bg-black">
      ...
      <main className="flex-grow bg-black">
        ...
        <div className="flex justify-between mt-4 mx-6 max-w-full">
          <button
            className="w-1/2 mx-2 py-3 bg-[#1E3545] text-white font-semibold rounded-md transition duration-200 hover:bg-white hover:text-black"
            onClick={() => setActiveButton('datos')}
          >
            Datos Personales
          </button>
          <button
